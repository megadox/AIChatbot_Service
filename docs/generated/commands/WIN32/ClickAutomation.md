# Activity: ClickAutomation

## Summary
윈도우 애플리케이션 오브젝트(컨트롤)에 마우스 클릭을 수행하는 액티비티
...
|---|---|---|---|---|
| `anchor` | `string` | `"center"` | `"center"`, `"topLeft"`, `"topRight"`, `"bottomLeft"`, `"bottomRight"` | 클릭할 위치를 지정할 때 기준점을 지정합니다.<br/>"center": 윈도우 객체의 중앙을 기준으로 클릭한다.<br/>"topLeft": 윈도우 객체의 좌상단을 기준으로 클릭한다.<br/>"topRight": 윈도우 객체의 우상단을 기준으로 클릭한다.<br/>"bottomLeft": 윈도우 객체의 좌하단을 기준으로 클릭한다.<br/>"bottomRight": 윈도우 객체의 우하단을 기준으로 클릭한다. |
...
| `offsetX` | `string` | `0` | - | 클릭할 위치의 X축 오프셋을 지정합니다.<br/>ex) 10 |
| `offsetY` | `string` | `0` | - | 클릭할 위치의 Y축 오프셋을 지정합니다.<br/>ex) 10 |
...
### `offsetX`
클릭할 위치의 X축 오프셋을 지정합니다.
ex) 10

### `offsetY`
클릭할 위치의 Y축 오프셋을 지정합니다.
ex) 10

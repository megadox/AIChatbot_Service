# Activity: GetWorksheetAsCollection

## Summary
특정 워크시트 전체의 값을 리스트 형태로 Name필드에 지정된 변수에 저장하는 액티비티

## Metadata
- group: `EXCEL`
- script: `GetWorksheetAsCollection()`
- pattern: `excel\.GetWorksheetAsCollection\(`
- dependencies: `EXCEL`
- theme: `Accent6_5`
- prefix: `collection`
